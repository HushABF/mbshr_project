...
import 'package:mbshr_project/core/theming/font_weight_helper.dart';
...
class TextStyles {
  ...
  static TextStyle font14DarkCyanMedium = TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeightHelper.medium,
    color: ColorsManager.darkCyan,
  );
  static TextStyle font12DarkCyanMedium = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.medium,
    color: ColorsManager.darkCyan,
  );
  static TextStyle font14DarkCyanSemiBold = TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeightHelper.semiBold,
    color: ColorsManager.darkCyan,
  );
